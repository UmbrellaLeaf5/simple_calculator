...
class Ui_Window:
  def setupUi(self, Window: QtWidgets.QWidget):
    ...
    self.pushButton_percent = CalcButton(
      ...
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_rev = CalcButton(
      "pushButton_rev",
      back_color="rgb(40, 40, 40);",
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_sqr = CalcButton(
      "pushButton_sqr",
      back_color="rgb(40, 40, 40);",
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_sqrt = CalcButton(
      "pushButton_sqrt",
      back_color="rgb(40, 40, 40);",
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_div = CalcButton(
      "pushButton_div",
      back_color="rgb(40, 40, 40);",
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_mul = CalcButton(
      "pushButton_mul",
      back_color="rgb(40, 40, 40);",
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_minus = CalcButton(
      "pushButton_minus",
      back_color="rgb(40, 40, 40);",
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_plus = CalcButton(
      "pushButton_plus",
      back_color="rgb(40, 40, 40);",
      hover_color="rgb(59, 59, 59);",
      pressed_color="rgb(40, 40, 40);",
    ...
    self.pushButton_eq = CalcButton(
      "pushButton_eq",
      back_color="rgb(97, 186, 97);",
      hover_color="rgb(90, 170, 90);",
      pressed_color="rgb(83, 154, 83);",
      parent=self.verticalLayoutWidget,
    )
